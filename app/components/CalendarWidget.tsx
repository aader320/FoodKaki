...
const CalendarWidget: React.FC = () => {
  ...
  const formattedMonthlyRemainingBudget = "$" + remainingMonthlyBudget.toFixed(2);
    ...
    <div className="flex border rounded shadow p-4">
      ...
      <div className="w-1/3 flex items-center justify-center">
        <div className="text-center">
          <h2 className="ml-5 text-sm md:text-3xl sm:text-md font-bold">Remaining Monthly Budget</h2>
          <p className="ml-5 text-sm md:text-xl">{formattedMonthlyRemainingBudget}</p>
          <h2 className="ml-5 text-sm md:text-3xl sm:text-md font-bold mt-4">Remaining Daily Budget</h2>
